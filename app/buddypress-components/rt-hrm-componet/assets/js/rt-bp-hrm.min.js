...
}).on("DOMNodeRemoved DOMAttrModified","["+this.attr_name()+"]:not(a)",function(){c.hide(d(this))})},ie_touch:function(){return!1},showTip:function(a){var b=this.getTip(a);return this.should_show(a,b)?this.show(a):void 0},getTip:function(b){var c=this.selector(b),d=a.extend({},this.settings,this.data_options(b)),e=null;return c&&(e=this.S('span[data-selector="'+c+'"]'+d.tooltip_class)),"object"==typeof e?e:!1},selector:function(a){var b=a.attr("id"),c=a.attr(this.attr_name())||a.attr("data-selector");return(b&&b.length<1||!b)&&"string"!=typeof c&&(c=this.random_str(6),a.attr("data-selector",c).attr("aria-describedby",c)),b&&b.length>0?b:c},create:function(c){var d=this,e=a.extend({},this.settings,this.data_options(c)),f=this.settings.tip_template;"string"==typeof e.tip_template&&b.hasOwnProperty(e.tip_template)&&(f=b[e.tip_template]);var g=a(f(this.selector(c),a("<div></div>").html(c.attr("title")).html())),h=this.inheritable_classes(c);g.addClass(h).appendTo(e.append_to),Modernizr.touch&&(g.append('<span class="tap-to-close">'+e.touch_close_text+"</span>"),g.on("touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip",function(){d.hide(c)})),c.removeAttr("title").attr("title","")},reposition:function(b,c,d){var e,f,g,h,i;if(c.css("visibility","hidden").show(),e=b.data("width"),f=c.children(".nub"),g=f.outerHeight(),h=f.outerHeight(),c.css(this.small()?{width:"100%"}:{width:e?e:"auto"}),i=function(a,b,c,d,e){return a.css({top:b?b:"auto",bottom:d?d:"auto",left:e?e:"auto",right:c?c:"auto"}).end()},i(c,b.offset().top+b.outerHeight()+10,"auto","auto",b.offset().left),this.small())i(c,b.offset().top+b.outerHeight()+10,"auto","auto",12.5,a(this.scope).width()),c.addClass("tip-override"),i(f,-g,"auto","auto",b.offset().left);else{var j=b.offset().left;Foundation.rtl&&(f.addClass("rtl"),j=b.offset().left+b.outerWidth()-c.outerWidth()),i(c,b.offset().top+b.outerHeight()+10,"auto","auto",j),c.removeClass("tip-override"),d&&d.indexOf("tip-top")>-1?(Foundation.rtl&&f.addClass("rtl"),i(c,b.offset().top-c.outerHeight(),"auto","auto",j).removeClass("tip-override")):d&&d.indexOf("tip-left")>-1?(i(c,b.offset().top+b.outerHeight()/2-c.outerHeight()/2,"auto","auto",b.offset().left-c.outerWidth()-g).removeClass("tip-override"),f.removeClass("rtl")):d&&d.indexOf("tip-right")>-1&&(i(c,b.offset().top+b.outerHeight()/2-c.outerHeight()/2,"auto","auto",b.offset().left+b.outerWidth()+g).removeClass("tip-override"),f.removeClass("rtl"))}c.css("visibility","visible").hide()},small:function(){return matchMedia(Foundation.media_queries.small).matches&&!matchMedia(Foundation.media_queries.medium).matches},inheritable_classes:function(b){var c=a.extend({},this.settings,this.data_options(b)),d=["tip-top","tip-left","tip-bottom","tip-right","radius","round"].concat(c.additional_inheritable_classes),e=b.attr("class"),f=e?a.map(e.split(" "),function(b){return-1!==a.inArray(b,d)?b:void 0}).join(" "):"";return a.trim(f)},convert_to_touch:function(b){var c=this,d=c.getTip(b),e=a.extend({},c.settings,c.data_options(b));0===d.find(".tap-to-close").length&&(d.append('<span class="tap-to-close">'+e.touch_close_text+"</span>"),d.on("click.fndtn.tooltip.tapclose touchstart.fndtn.tooltip.tapclose MSPointerDown.fndtn.tooltip.tapclose",function(){c.hide(b)})),b.data("tooltip-open-event-type","touch")},show:function(a){var b=this.getTip(a);"touch"==a.data("tooltip-open-event-type")&&this.convert_to_touch(a),this.reposition(a,b,a.attr("class")),a.addClass("open"),b.fadeIn(150)},hide:function(a){var b=this.getTip(a);b.fadeOut(150,function(){b.find(".tap-to-close").remove(),b.off("click.fndtn.tooltip.tapclose MSPointerDown.fndtn.tapclose"),a.removeClass("open")})},off:function(){var b=this;this.S(this.scope).off(".fndtn.tooltip"),this.S(this.settings.tooltip_class).each(function(c){a("["+b.attr_name()+"]").eq(c).attr("title",a(this).text())}).remove()},reflow:function(){}}}(jQuery,window,window.document),function(a,b,c){"use strict";Foundation.libs.topbar={name:"topbar",version:"5.4.6",settings:{index:0,sticky_class:"sticky",custom_back_text:!0,back_text:"Back",mobile_show_parent_link:!0,is_hover:!0,scrolltop:!0,sticky_on:"all"},init:function(b,c,d){Foundation.inherit(this,"add_custom_rule register_media throttle");var e=this;e.register_media("topbar","foundation-mq-topbar"),this.bindings(c,d),e.S("["+this.attr_name()+"]",this.scope).each(function(){var b=a(this),c=b.data(e.attr_name(!0)+"-init");e.S("section, .top-bar-section",this),b.data("index",0);var d=b.parent();d.hasClass("fixed")||e.is_sticky(b,d,c)?(e.settings.sticky_class=c.sticky_class,e.settings.sticky_topbar=b,b.data("height",d.outerHeight()),b.data("stickyoffset",d.offset().top)):b.data("height",b.outerHeight()),c.assembled||e.assemble(b),c.is_hover?e.S(".has-dropdown",b).addClass("not-click"):e.S(".has-dropdown",b).removeClass("not-click"),e.add_custom_rule(".f-topbar-fixed { padding-top: "+b.data("height")+"px }"),d.hasClass("fixed")&&e.S("body").addClass("f-topbar-fixed")})},is_sticky:function(a,b,c){var d=b.hasClass(c.sticky_class);return d&&"all"===c.sticky_on?!0:d&&this.small()&&"small"===c.sticky_on?matchMedia(Foundation.media_queries.small).matches&&!matchMedia(Foundation.media_queries.medium).matches&&!matchMedia(Foundation.media_queries.large).matches:d&&this.medium()&&"medium"===c.sticky_on?matchMedia(Foundation.media_queries.small).matches&&matchMedia(Foundation.media_queries.medium).matches&&!matchMedia(Foundation.media_queries.large).matches:d&&this.large()&&"large"===c.sticky_on?matchMedia(Foundation.media_queries.small).matches&&matchMedia(Foundation.media_queries.medium).matches&&matchMedia(Foundation.media_queries.large).matches:!1},toggle:function(c){var d,e=this;d=c?e.S(c).closest("["+this.attr_name()+"]"):e.S("["+this.attr_name()+"]");var f=d.data(this.attr_name(!0)+"-init"),g=e.S("section, .top-bar-section",d);e.breakpoint()&&(e.rtl?(g.css({right:"0%"}),a(">.name",g).css({right:"100%"})):(g.css({left:"0%"}),a(">.name",g).css({left:"100%"})),e.S("li.moved",g).removeClass("moved"),d.data("index",0),d.toggleClass("expanded").css("height","")),f.scrolltop?d.hasClass("expanded")?d.parent().hasClass("fixed")&&(f.scrolltop?(d.parent().removeClass("fixed"),d.addClass("fixed"),e.S("body").removeClass("f-topbar-fixed"),b.scrollTo(0,0)):d.parent().removeClass("expanded")):d.hasClass("fixed")&&(d.parent().addClass("fixed"),d.removeClass("fixed"),e.S("body").addClass("f-topbar-fixed")):(e.is_sticky(d,d.parent(),f)&&d.parent().addClass("fixed"),d.parent().hasClass("fixed")&&(d.hasClass("expanded")?(d.addClass("fixed"),d.parent().addClass("expanded"),e.S("body").addClass("f-topbar-fixed")):(d.removeClass("fixed"),d.parent().removeClass("expanded"),e.update_sticky_positioning())))},timer:null,events:function(){var c=this,d=this.S;d(this.scope).off(".topbar").on("click.fndtn.topbar","["+this.attr_name()+"] .toggle-topbar",function(a){a.preventDefault(),c.toggle(this)}).on("click.fndtn.topbar",'.top-bar .top-bar-section li a[href^="#"],['+this.attr_name()+'] .top-bar-section li a[href^="#"]',function(){var b=a(this).closest("li");!c.breakpoint()||b.hasClass("back")||b.hasClass("has-dropdown")||c.toggle()}).on("click.fndtn.topbar","["+this.attr_name()+"] li.has-dropdown",function(b){var e=d(this),f=d(b.target),g=e.closest("["+c.attr_name()+"]"),h=g.data(c.attr_name(!0)+"-init");return f.data("revealId")?void c.toggle():void(c.breakpoint()||(!h.is_hover||Modernizr.touch)&&(b.stopImmediatePropagation(),e.hasClass("hover")?(e.removeClass("hover").find("li").removeClass("hover"),e.parents("li.hover").removeClass("hover")):(e.addClass("hover"),a(e).siblings().removeClass("hover"),"A"===f[0].nodeName&&f.parent().hasClass("has-dropdown")&&b.preventDefault())))}).on("click.fndtn.topbar","["+this.attr_name()+"] .has-dropdown>a",function(a){if(c.breakpoint()){a.preventDefault();var b=d(this),e=b.closest("["+c.attr_name()+"]"),f=e.find("section, .top-bar-section"),g=(b.next(".dropdown").outerHeight(),b.closest("li"));e.data("index",e.data("index")+1),g.addClass("moved"),c.rtl?(f.css({right:-(100*e.data("index"))+"%"}),f.find(">.name").css({right:100*e.data("index")+"%"})):(f.css({left:-(100*e.data("index"))+"%"}),f.find(">.name").css({left:100*e.data("index")+"%"})),e.css("height",b.siblings("ul").outerHeight(!0)+e.data("height"))}}),d(b).off(".topbar").on("resize.fndtn.topbar",c.throttle(function(){c.resize.call(c)},50)).trigger("resize").trigger("resize.fndtn.topbar").load(function(){d(this).trigger("resize.fndtn.topbar")}),d("body").off(".topbar").on("click.fndtn.topbar",function(a){var b=d(a.target).closest("li").closest("li.hover");b.length>0||d("["+c.attr_name()+"] li.hover").removeClass("hover")}),d(this.scope).on("click.fndtn.topbar","["+this.attr_name()+"] .has-dropdown .back",function(a){a.preventDefault();var b=d(this),e=b.closest("["+c.attr_name()+"]"),f=e.find("section, .top-bar-section"),g=(e.data(c.attr_name(!0)+"-init"),b.closest("li.moved")),h=g.parent();e.data("index",e.data("index")-1),c.rtl?(f.css({right:-(100*e.data("index"))+"%"}),f.find(">.name").css({right:100*e.data("index")+"%"})):(f.css({left:-(100*e.data("index"))+"%"}),f.find(">.name").css({left:100*e.data("index")+"%"})),0===e.data("index")?e.css("height",""):e.css("height",h.outerHeight(!0)+e.data("height")),setTimeout(function(){g.removeClass("moved")},300)}),d(this.scope).find(".dropdown a").focus(function(){a(this).parents(".has-dropdown").addClass("hover")}).blur(function(){a(this).parents(".has-dropdown").removeClass("hover")})},resize:function(){var a=this;a.S("["+this.attr_name()+"]").each(function(){var b,d=a.S(this),e=d.data(a.attr_name(!0)+"-init"),f=d.parent("."+a.settings.sticky_class);if(!a.breakpoint()){var g=d.hasClass("expanded");d.css("height","").removeClass("expanded").find("li").removeClass("hover"),g&&a.toggle(d)}a.is_sticky(d,f,e)&&(f.hasClass("fixed")?(f.removeClass("fixed"),b=f.offset().top,a.S(c.body).hasClass("f-topbar-fixed")&&(b-=d.data("height")),d.data("stickyoffset",b),f.addClass("fixed")):(b=f.offset().top,d.data("stickyoffset",b)))})},breakpoint:function(){return!matchMedia(Foundation.media_queries.topbar).matches},small:function(){return matchMedia(Foundation.media_queries.small).matches},medium:function(){return matchMedia(Foundation.media_queries.medium).matches},large:function(){return matchMedia(Foundation.media_queries.large).matches},assemble:function(b){var c=this,d=b.data(this.attr_name(!0)+"-init"),e=c.S("section, .top-bar-section",b);e.detach(),c.S(".has-dropdown>a",e).each(function(){var b,e=c.S(this),f=e.siblings(".dropdown"),g=e.attr("href");f.find(".title.back").length||(b=a(1==d.mobile_show_parent_link&&g?'<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li><li class="parent-link show-for-small"><a class="parent-link js-generated" href="'+g+'">'+e.html()+"</a></li>":'<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5>'),a("h5>a",b).html(1==d.custom_back_text?d.back_text:"&laquo; "+e.html()),f.prepend(b))}),e.appendTo(b),this.sticky(),this.assembled(b)},assembled:function(b){b.data(this.attr_name(!0),a.extend({},b.data(this.attr_name(!0)),{assembled:!0}))},height:function(b){var c=0,d=this;return a("> li",b).each(function(){c+=d.S(this).outerHeight(!0)}),c},sticky:function(){var a=this;this.S(b).on("scroll",function(){a.update_sticky_positioning()})},update_sticky_positioning:function(){var a="."+this.settings.sticky_class,c=this.S(b),d=this;if(d.settings.sticky_topbar&&d.is_sticky(this.settings.sticky_topbar,this.settings.sticky_topbar.parent(),this.settings)){var e=this.settings.sticky_topbar.data("stickyoffset");d.S(a).hasClass("expanded")||(c.scrollTop()>e?d.S(a).hasClass("fixed")||(d.S(a).addClass("fixed"),d.S("body").addClass("f-topbar-fixed")):c.scrollTop()<=e&&d.S(a).hasClass("fixed")&&(d.S(a).removeClass("fixed"),d.S("body").removeClass("f-topbar-fixed")))}},off:function(){this.S(this.scope).off(".fndtn.topbar"),this.S(b).off(".fndtn.topbar")},reflow:function(){}}}(jQuery,window,window.document),jQuery(document).ready(function(a){a(".deletepostlink").click(function(){var a=confirm("Are you sure you want to delete this leave?");return 1!=a?!1:void 0});var b={init:function(){},leaveListing:function(){var b=1,c="",d="",e=999999;1==b?a("#leave-pagination li#prev").hide():a("#leave-pagination li#prev").show(),e==b?a("#leave-pagination li#next").hide():a("#leave-pagination li#next").show(),a(".leave-lists .lists-header th.order").click(function(){c=a(this).data("sorting-type"),d=a(this).data("attr-type"),"DESC"===c&&(a(this).children().remove(),a(this).append('<span><i class="fa fa-caret-down"></i></span>'),a(this).data("sorting-type","ASC")),"ASC"===c&&(a(this).children().remove(),a(this).append('<span><i class="fa fa-caret-up"></i></span>'),a(this).data("sorting-type","DESC")),a(".leave-lists tr.lists-data").remove(),a.ajax({url:ajaxurl,dataType:"json",type:"POST",data:{action:"leave_listing_info",order:c,attr:d,paged:b},beforeSend:function(){a(".leave-lists tr.lists-header").after('<tr id="loading" style="text-align:right"><td colspan="7" align="right"><img src="'+rthrmurl+'app/assets/img/loading.gif"/></td></tr>')},success:function(b){a.each(b,function(c){a(".leave-lists tr.lists-header").after('<tr class="lists-data"><td class="leavetype">'+b[c].leavetype+'<br /><span><a href="'+b[c].editpostlink+'">Edit</a></span>&nbsp;&#124;<a href="'+b[c].permalink+'">View</a></td><td>'+b[c].leavestartdate+"</td><td>"+b[c].leaveenddate+'</td><td class="'+b[c].poststatus+'">'+b[c].poststatus+"</td></tr>")}),0===b.length?(a(".leave-lists tr.lists-data").remove(),a("ul#leave-pagination").remove(),a(".leave-lists tr.lists-header").after('<tr class="lists-data"><td colspan="7" align="center" scope="row">No Leave Listing</td></tr>'),a(".leave-lists #loading").remove()):a(".leave-lists #loading").remove()},error:function(b,c,d){a(".leave-lists #loading").remove(),alert(b+" :: "+c+" :: "+d)}})}),a("#leave-pagination li#next").click(function(){b++,a(".leave-lists tr.lists-data").remove(),a.ajax({url:ajaxurl,dataType:"json",type:"POST",data:{action:"leave_listing_info",order:c,attr:d,paged:b},beforeSend:function(){a(".leave-lists tr.lists-header").after('<tr id="loading" style="text-align:right"><td colspan="7" align="right"><img src="'+rthrmurl+'app/assets/img/loading.gif"/></td></tr>')},success:function(c){0!=c.length&&(e=c[0].max_num_pages),e==b?a("#leave-pagination li#next").hide():a("#leave-pagination li#next").show(),1==b?a("#leave-pagination li#prev").hide():a("#leave-pagination li#prev").show(),a.each(c,function(b){a(".leave-lists tr.lists-header").after('<tr class="lists-data"><td class="leavetype">'+c[b].leavetype+'<br /><span><a href="'+c[b].editpostlink+'">Edit</a></span>&nbsp;&#124;<a href="'+c[b].permalink+'">View</a></td><td>'+c[b].leavestartdate+"</td><td>"+c[b].leaveenddate+'</td><td class="'+c[b].poststatus+'">'+c[b].poststatus+"</td></tr>")}),0===c.length?(a(".leave-lists tr.lists-data").remove(),a("ul#leave-pagination").remove(),a(".leave-lists tr.lists-header").after('<tr class="lists-data"><td colspan="7" align="center" scope="row">No Leave Listing</td></tr>'),a(".leave-lists #loading").remove()):a(".leave-lists #loading").remove()},error:function(b,c,d){a(".leave-lists #loading").remove(),alert(b+" :: "+c+" :: "+d)}})}),a("#leave-pagination li#prev").click(function(){b--,a(".leave-lists tr.lists-data").remove(),a.ajax({url:ajaxurl,dataType:"json",type:"POST",data:{action:"leave_listing_info",order:c,attr:d,paged:b},beforeSend:function(){a(".leave-lists tr.lists-header").after('<tr id="loading" style="text-align:right"><td colspan="7" align="right"><img src="'+rthrmurl+'app/assets/img/loading.gif"/></td></tr>')},success:function(c){0!=c.length&&(e=c[0].max_num_pages),e==b?a("#leave-pagination li#next").hide():a("#leave-pagination li#next").show(),1==b?a("#leave-pagination li#prev").hide():a("#leave-pagination li#prev").show(),a.each(c,function(b){a(".leave-lists tr.lists-header").after('<tr class="lists-data"><td class="leavetype">'+c[b].leavetype+'<br /><span><a href="'+c[b].editpostlink+'">Edit</a></span>&nbsp;&#124;<a href="'+c[b].permalink+'">View</a></td><td>'+c[b].leavestartdate+"</td><td>"+c[b].leaveenddate+'</td><td class="'+c[b].poststatus+'">'+c[b].poststatus+"</td></tr>")}),0===c.length?(a(".leave-lists tr.lists-data").remove(),a("ul#leave-pagination").remove(),a(".leave-lists tr.lists-header").after('<tr class="lists-data"><td colspan="7" align="center" scope="row">No Leave Listing</td></tr>'),a(".leave-lists #loading").remove()):a(".leave-lists #loading").remove()},error:function(b,c,d){a(".leave-lists #loading").remove(),alert(b+" :: "+c+" :: "+d)}})})},requestsListing:function(){var b=1,c="",d="",e=999999;1==b?a("#requests-pagination li#prev").hide():a("#requests-pagination li#prev").show(),e==b?a("#requests-pagination li#next").hide():a("#requests-pagination li#next").show(),a(".requests-lists .lists-header th.order").click(function(){c=a(this).data("sorting-type"),d=a(this).data("attr-type"),"DESC"===c&&(a(this).children().remove(),a(this).append('<span><i class="fa fa-caret-down"></i></span>'),a(this).data("sorting-type","ASC")),"ASC"===c&&(a(this).children().remove(),a(this).append('<span><i class="fa fa-caret-up"></i></span>'),a(this).data("sorting-type","DESC")),a(".requests-lists tr.lists-data").remove(),a.ajax({url:ajaxurl,dataType:"json",type:"POST",data:{action:"requests_listing_info",order:c,attr:d,paged:b},beforeSend:function(){a(".requests-lists tr.lists-header").after('<tr id="loading" style="text-align:right"><td colspan="7" align="right"><img src="'+rthrmurl+'app/assets/img/loading.gif"/></td></tr>')},success:function(b){a.each(b,function(c){a(".requests-lists tr.lists-header").after('<tr class="lists-data"><td align="center" scope="row">'+b[c].avatar+'</td><td class="leaveuservalue">'+b[c].leaveuservalue+'<br /><span><a href="'+b[c].editpostlink+'">Edit</a></span>&nbsp;&#124;<a href="'+b[c].permalink+'">View</a>&#124;&nbsp;<a class="deletepostlink" href="'+b[c].deletepostlink+'">Delete</a></td><td>'+b[c].leavetype+"</td><td>"+b[c].leavestartdate+"</td><td>"+b[c].leaveenddate+"</td><td>"+b[c].poststatus+"</td><td>"+b[c].approver+"</td></tr>")}),0===b.length?(a(".requests-lists tr.lists-data").remove(),a("ul#requests-pagination").remove(),a(".requests-lists tr.lists-header").after('<tr class="lists-data"><td colspan="7" align="center" scope="row">No Leave Listing</td></tr>'),a(".requests-lists #loading").remove()):a(".requests-lists #loading").remove()},error:function(b,c,d){a(".requests-lists #loading").remove(),alert(b+" :: "+c+" :: "+d)}})}),a("#requests-pagination li#next").click(function(){b++,a(".requests-lists tr.lists-data").remove(),a.ajax({url:ajaxurl,dataType:"json",type:"POST",data:{action:"requests_listing_info",order:c,attr:d,paged:b},beforeSend:function(){a(".requests-lists tr.lists-header").after('<tr id="loading" style="text-align:right"><td colspan="7" align="right"><img src="'+rthrmurl+'app/assets/img/loading.gif"/></td></tr>')},success:function(c){0!=c.length&&(e=c[0].max_num_pages),e==b?a("#requests-pagination li#next").hide():a("#requests-pagination li#next").show(),1==b?a("#requests-pagination li#prev").hide():a("#requests-pagination li#prev").show(),a.each(c,function(b){a(".requests-lists tr.lists-header").after('<tr class="lists-data"><td align="center" scope="row">'+c[b].avatar+'</td><td class="leaveuservalue">'+c[b].leaveuservalue+'<br /><span><a href="'+c[b].editpostlink+'">Edit</a></span>&nbsp;&#124;<a href="'+c[b].permalink+'">View</a>&#124;&nbsp;<a class="deletepostlink" href="'+c[b].deletepostlink+'">Delete</a></td><td>'+c[b].leavetype+"</td><td>"+c[b].leavestartdate+"</td><td>"+c[b].leaveenddate+"</td><td>"+c[b].poststatus+"</td><td>"+c[b].approver+"</td></tr>")}),0===c.length?(a(".requests-lists tr.lists-data").remove(),a("ul#requests-pagination").remove(),a(".requests-lists tr.lists-header").after('<tr class="lists-data"><td colspan="7" align="center" scope="row">No Leave Listing</td></tr>'),a(".requests-lists #loading").remove()):a(".requests-lists #loading").remove()},error:function(b,c,d){a(".requests-lists #loading").remove(),alert(b+" :: "+c+" :: "+d)}})}),a("#requests-pagination li#prev").click(function(){b--,a(".requests-lists tr.lists-data").remove(),a.ajax({url:ajaxurl,dataType:"json",type:"POST",data:{action:"requests_listing_info",order:c,attr:d,paged:b},beforeSend:function(){a(".requests-lists tr.lists-header").after('<tr id="loading" style="text-align:right"><td colspan="7" align="right"><img src="'+rthrmurl+'app/assets/img/loading.gif"/></td></tr>')},success:function(c){0!=c.length&&(e=c[0].max_num_pages),e==b?a("#requests-pagination li#next").hide():a("#requests-pagination li#next").show(),1==b?a("#requests-pagination li#prev").hide():a("#requests-pagination li#prev").show(),a.each(c,function(b){a(".requests-lists tr.lists-header").after('<tr class="lists-data"><td align="center" scope="row">'+c[b].avatar+'</td><td class="leaveuservalue">'+c[b].leaveuservalue+'<br /><span><a href="'+c[b].editpostlink+'">Edit</a></span>&nbsp;&#124;<a href="'+c[b].permalink+'">View</a>&#124;&nbsp;<a class="deletepostlink" href="'+c[b].deletepostlink+'">Delete</a></td><td>'+c[b].leavetype+"</td><td>"+c[b].leavestartdate+"</td><td>"+c[b].leaveenddate+"</td><td>"+c[b].poststatus+"</td><td>"+c[b].approver+"</td></tr>")}),0===c.length?(a(".requests-lists tr.lists-data").remove(),a("ul#requests-pagination").remove(),a(".requests-lists tr.lists-header").after('<tr class="lists-data"><td colspan="7" align="center" scope="row">No Leave Listing</td></tr>'),a(".requests-lists #loading").remove()):a(".requests-lists #loading").remove()},error:function(b,c,d){a(".requests-lists #loading").remove(),alert(b+" :: "+c+" :: "+d)}})})}};b.init()}),jQuery(document).ready(function(a){function b(b,c){a(b).addClass("error"),a(b).next().length>0&&a(b).next().hasClass("error")?a(b).next().html(c):a(b).after("<small class='error'>"+c+"</small>")}function c(b){a(b).removeClass("error"),a(b).next().length>0&&a(b).next().hasClass("error")&&a(b).next().remove()}var d={init:function(){d.eleLeaveUserID=a("#leave-user-id"),d.eleLeaveUser=a(".user-autocomplete"),d.eleLeaveType=a('input[name="post[leave-type][]"]:checked'),d.lblLeaveStartDate=a("#lblleave-start-date"),d.eleLevaeStartDate=a("#leave-start-date"),d.eleLevaeDayType=a("#leave-duration"),d.eleLevaeEndDate=a("#leave-end-date"),d.eleLevaeDesc=a("#leave_description"),d.eleLeaveQuotaUse=a("#leave_quota_use"),d.initDatePicker(),d.initRtCalenderMethod(),d.leaveDayChange(),d.leaveDayCheck(),d.add_leave_validate(),d.autocompleteUser(),d.paidLeaveChange(),d.initDashboardWPMenuHack()},initDatePicker:function(){a(document).on("focus",".datepicker",function(){a(this).datepicker({dateFormat:"dd/mm/yy"})})},initRtCalenderMethod:function(){d.employeeId=d.eleLeaveUserID.val(),d.employeeName=d.eleLeaveUser.val(),a("#calendar-container").on("rtBeforePopup",d.rtHrmBeforePopup),a("#calendar-container").on("rtEventClick",d.rtHrmEventClick)},rtHrmBeforePopup:function(b,e,f){return d.lblLeaveStartDate.text(moment(f).format("MMMM DD YYYY, dddd")),d.eleLevaeStartDate.val(moment(f).format("DD/MM/YYYY")),d.eleLevaeEndDate.val(moment(f).format("DD/MM/YYYY")),d.eleLeaveUserID.val(d.employeeId),d.eleLeaveUser.val(d.employeeName),a('input[name="post[leave-type][]"]:checked').attr("checked",!1),d.eleLevaeDesc.val(""),c(d.eleLevaeStartDate),c(d.eleLevaeEndDate),!1},rtHrmEventClick:function(a,b,c){window.location=frontendhrmurl+"/leave/?rt_leave_id="+c.leave_id+"&action=edit"},leaveDayChange:function(){"Other"==d.eleLevaeDayType.val()||"other"==d.eleLevaeDayType.val()?d.eleLevaeEndDate.parent().parent().parent().show():(d.eleLevaeEndDate.val(""),d.eleLevaeEndDate.parent().parent().parent().hide()),a(document).on("change","#"+d.eleLevaeDayType.attr("id"),function(){"Other"==a(this).val()||"other"==a(this).val()?d.eleLevaeEndDate.parent().parent().parent().show():(d.eleLevaeEndDate.val(""),d.eleLevaeEndDate.parent().parent().parent().hide())})},paidLeaveChange:function(){d.eleLeaveUserID.bind("change"),d.eleLeaveUserID.on("change",function(b){b.preventDefault(),d.eleLeaveQuotaUse.closest("tr").addClass("hide"),d.eleLeaveQuotaUse.prop("checked",!1).change(),""!=a(this).val().trim()&&(employee_id=a(this).val(),a.post(ajaxurl,{action:"rt_hrm_check_user_leave_quota",employee_id:employee_id},function(b){b=a.parseJSON(b),"success"==b.status&&(a("#remaining-leave-quota").text(b.leave_quota),d.eleLeaveQuotaUse.closest("tr").removeClass("hide"))}))})},add_leave_validate:function(){a("#post, #form-add-leave").submit(function(a){try{if("undefined"==typeof d.eleLeaveUserID.val()||""==d.eleLeaveUserID.val().trim()||""==d.eleLeaveUser.val().trim())return b(d.eleLeaveUserID,"Please Enter valid Employee Name"),d.removeLodingOnNewPost(),!1;if("undefined"==typeof d.eleLevaeStartDate.val()||""==d.eleLevaeStartDate.val().trim())return b(d.eleLevaeStartDate,"Please Enter the Leave Start Date"),d.removeLodingOnNewPost(),!1;if(c(d.eleLevaeStartDate),"other"==d.eleLevaeDayType.val().trim()&&""==d.eleLevaeEndDate.val().trim())return b(d.eleLevaeEndDate,"Please Enter the Leave End Date"),d.removeLodingOnNewPost(),!1;c(d.eleLevaeEndDate)}catch(a){return console.log(a),!1}})},autocompleteUser:function(){d.eleLeaveUser.length>0&&(d.eleLeaveUser.autocomplete({source:function(b,c){d.eleLeaveUserID.val("").trigger("change"),a.ajax({url:ajaxurl,dataType:"json",type:"post",data:{action:"seach_employees_name",maxRows:10,query:b.term},success:function(b){c(a.map(b,function(a){return{id:a.id,label:a.label}}))}})},minLength:2,select:function(a,b){return d.eleLeaveUser.val(b.item.label),d.eleLeaveUserID.val(b.item.id).trigger("change"),!1}}).data("ui-autocomplete")._renderItem=function(b,c){return a("<li></li>").data("ui-autocomplete-item",c).append("<a class='ac-subscribe-selected'>"+c.label+"</a>").appendTo(b)})},removeLodingOnNewPost:function(){a("#save-action #save-post").removeClass("button-disabled"),a("#save-action #save-post").val("Save Draft"),a("#save-action span").attr("style","display: none;"),a("#publishing-action #save-publish").removeClass("button-primary-disabled")},initDashboardWPMenuHack:function(){"undefined"!=typeof rt_hrm_top_menu&&"undefined"!=typeof rt_hrm_dashboard_url&&(a("#"+rt_hrm_top_menu+" ul li").removeClass("current"),a("#"+rt_hrm_top_menu+" ul li a").removeClass("current"),a("#"+rt_hrm_top_menu+" ul li a").each(function(){this.href==rt_hrm_dashboard_url&&(a(this).parent().addClass("current"),a(this).addClass("current"))}))},leaveDayCheck:function(){a("#leave-start-date").change(function(){(""==!d.eleLeaveUserID.val().trim()||""==!d.eleLeaveUser.val().trim())&&a.post(ajaxurl,{action:"rt_hrm_check_leave_day",leave_user_id:d.eleLeaveUserID.val().trim(),leave_start_date:d.eleLevaeStartDate.val().trim()},function(e){e=a.parseJSON(e),"error"==e.status?(d.eleLevaeStartDate.val(""),b(d.eleLevaeStartDate,e.message)):c(d.eleLevaeStartDate)})})}};d.init()});